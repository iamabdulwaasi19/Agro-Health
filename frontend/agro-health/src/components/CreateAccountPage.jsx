...
export function CreateAccountPage() {
  ...
  // Trims extra space from fullName
  ...
  const handleSubmit = async (e) => {
    ...
    if (!agreed) {
      alert("You must agree to the Terms & Privacy Policy to create an account");
      return;
    }

    setIsLoading(true);

    // Send request to the backend signup API
    try {
      const res = await fetch(
        "https://agro-health.onrender.com/api/auth/signup",
        {
          method: "POST",
          headers: {
      ...
      // Navigates to verify users email
      if (res.ok) {
        ...
        <div className="flex items-center justify-center p-6 lg:p-12 bg-white lg:bg-transparent">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#1C8C36] font-bold text-xl">
                AgroHealth
              </span>
            </div>
            ...
            <div className="space-y-2">
              <h1 className="text-[#1C8C36] text-3xl font-bold">
                Create Account
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2 py-2">
                ...
                <label
                  htmlFor="terms"
                  className="text-[#4B5563] text-sm cursor-pointer"
                >
                  I agree to the{" "}
                  <a
                    href="#"
                    className="text-[#1C8C36] hover:underline font-medium"
                  >
