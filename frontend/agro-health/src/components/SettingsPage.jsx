...
//                     <p className={isDarkMode ? 'text-red-400' : 'text-[#000000]'} className="text-sm">
...
//                     <p className={isDarkMode ? 'text-gray-400' : 'text-[#4B5563]'} className="text-sm">
          ...
          <TabsContent value="profile">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email">Email</Label>
                  <Input id="email" type="email" value={formData.email} disabled className="opacity-60 bg-gray-100" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="phone">Phone Number</Label>
                  <Input 
                ...
                <Button onClick={handleSaveChanges} className="bg-[#1C8C36] hover:bg-[#156d2a] text-white mt-4" disabled={isSaving}>
                  {isSaving ? "Implementing Changes..." : "Save Changes"}
                </Button>
              </CardContent>
            </Card>
          ...
          <TabsContent value="security">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="curr-pass">Current Password</Label>
                  <Input id="curr-pass" type="password" value={currentPassInput} onChange={(e) => setCurrentPassInput(e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="new-pass">New Password</Label>
                  <Input id="new-pass" type="password" value={newPassInput} onChange={(e) => setNewPassInput(e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="confirm-pass">Confirm New Password</Label>
                  <Input id="confirm-pass" type="password" value={confirmPassInput} onChange={(e) => setConfirmPassInput(e.target.value)} />
                </div>
                <Button onClick={handleUpdatePassword} className="bg-[#1C8C36] hover:bg-[#156d2a] text-white">Update Password</Button>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Language</Label>
                    <p className="text-[#4B5563] text-sm">Choose your preferred language</p>
                  </div>
             ...
             <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Email notifications</Label>
                    <p className="text-[#4B5563] text-sm">Receive diagnosis results via email</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <Separator />
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Push notifications</Label>
                    <p className="text-[#4B5563] text-sm">Get alerts on your device</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <Separator />
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Weather alerts</Label>
                    <p className="text-[#4B5563] text-sm">Alerts for disease-favorable conditions</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <Separator />
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label>Treatment reminders</Label>
                    <p className="text-[#4B5563] text-sm">Remind me about scheduled treatments</p>
                  </div>
                  <Switch defaultChecked />
                </div>
