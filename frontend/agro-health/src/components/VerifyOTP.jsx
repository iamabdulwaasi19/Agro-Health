...
export function VerifyOTP() {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://agro-health.onrender.com/api/auth/verify-otp",
        {
          method: "POST",
  ...
  // Handles resend if first attempt fails
  const handleResend = async () => {
    try {
      const res = await fetch(
        "https://agro-health.onrender.com/api/auth/resend-otp",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
